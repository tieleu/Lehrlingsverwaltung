...
<body>
	<div id="uebersicht">
		...
		<div align="center" id="input_container">
			...
			<div id="totalTimeWrap"><?php echo "<input type='text' class='form-control' value='Total: ".minToTime($totalTimeAll-mysql_num_rows($getdates)*$solltime+$all_ShortSollTime+$totalWhileTimerRun-250-375)." h' readonly style='background-color: ".$totAllColor."; font-weight: bold;'>"
				?></div>
			</div>
		</body>
		</html>